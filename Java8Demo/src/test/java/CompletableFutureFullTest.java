...
/*        CompletableFuture<String> cf = CompletableFuture.completedFuture("message").thenApplyAsync(String::toUpperCase,
    ...
    public void thenCombineAsyncExample() {
        String original = "Message";
        CompletableFuture<String> cf = CompletableFuture.completedFuture(original).thenApplyAsync(s -> delayedUpperCase(s))
    ...
    public void thenComposeExample() {
        ...
        System.out.println("thenComposeExample thread = " + Thread.currentThread().getName());
        assertEquals("MESSAGEmessage", cf.join());
    }
