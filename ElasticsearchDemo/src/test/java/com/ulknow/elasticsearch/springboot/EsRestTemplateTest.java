package com.ulknow.elasticsearch.springboot;

import com.ulknow.elasticsearch.springboot.entity.Book;
...
public class EsRestTemplateTest {
    ...
    void testCreateIndex() {
        esRestTemplate.indexOps(Book.class).delete();
        esRestTemplate.indexOps(Book.class).create();
        esRestTemplate.indexOps(Book.class).putMapping(esRestTemplate.indexOps(Book.class).createMapping());
    }
