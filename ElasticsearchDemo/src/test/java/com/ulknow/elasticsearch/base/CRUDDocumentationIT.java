 ...
 */
public class CRUDDocumentationIT extends BaseTest {
            ...
            BulkProcessor.Listener listener = new BulkProcessor.Listener() {
                ...
                public void afterBulk(long executionId, BulkRequest request,
                    ...
                    if (response.hasFailures()) { // <2>
                        System.out.println("executed with failures"+executionId);
                    } else {
                        System.out.println("completed success"+ response.getTook().getMillis());
                    }
                }
                ...
                public void afterBulk(long executionId, BulkRequest request,
                        Throwable failure) {
                    System.out.println("Failed to execute bulk"+ failure); // <3>
                }
            };
